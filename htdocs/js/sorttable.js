...
/* modified by Samuel 2011-12-31: sort numbers with commas /*
...
function ts_sort_numeric(a,b) { 
 aa = tidy_number(ts_getInnerText(a.cells[SORT_COLUMN_INDEX]));
 if (isNaN(aa)) {
  aa = 0;
 }
 bb = tidy_number(ts_getInnerText(b.cells[SORT_COLUMN_INDEX])); 
 if (isNaN(bb)) {
  bb = 0;
 }
 return aa-bb;
